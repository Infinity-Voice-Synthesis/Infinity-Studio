...
std::function<void(juce::StringRef)> DMH::console_mesFunction;
std::function<void(juce::StringRef)> DMH::console_assFunction;
std::function<void()> DMH::console_clsFunction;

void DMH::reg_mesFunctions(
	std::function<void(juce::StringRef)> console_mesFunction,
	std::function<void(juce::StringRef)> console_assFunction,
